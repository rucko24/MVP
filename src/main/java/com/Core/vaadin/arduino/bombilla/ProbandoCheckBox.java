...
public class ProbandoCheckBox extends HorizontalLayout implements Field<String> {
	...
	static List<CheckBox> boxes = new LinkedList<CheckBox>();
	static CheckBox dayCheck;
